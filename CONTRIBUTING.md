...
2. Fork the repository by clicking on the ["Fork"](https://github.com/MihirRajeshPanchal/codelinelogger/fork) button at the top right corner of the page.


3. Once you are in your fork the url should look something like
`https://github.com/<YOUR-USERNAME>/codelinelogger/`
...
- For HTTP
 ```
   git clone https://github.com/<YOUR-USERNAME>/codelinelogger.git
 ```
- For SSH
 ```bash
   git clone git@github.com:<YOUR-USERNAME>/codelinelogger.git
 ```
...
5. Now you are in the `codelinelogger` folder
...
>NOTE: Please make sure to follow the [Code of conduct](https://github.com/MihirRajeshPanchal/codelinelogger/blob/master/CODE_OF_CONDUCT.md) while contributing.
